# E-Commerce Back End
  ...
  ## Description
  This app is the back end application for an E-Commerence application.
  ...
  ## Usage
  This app shows the back end for an e-commerence 	 application that with a database that tracks products, categories and tags
